...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB0     ------> ADC1_IN15
    */
    HAL_GPIO_DeInit(GPIOA, THERM_1_Pin|THERM_2_Pin|THERM_3_Pin|THERM_4_Pin
                          |THERM_5_Pin);

    HAL_GPIO_DeInit(GPIOC, THERM_6_Pin|THERM_7_Pin);

    HAL_GPIO_DeInit(THERM_8_GPIO_Port, THERM_8_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB1     ------> ADC2_IN16
    */
    HAL_GPIO_DeInit(CURRENT_SENSOR_GPIO_Port, CURRENT_SENSOR_Pin);
